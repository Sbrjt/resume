...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Built a modern, responsive dashboard using Next.js and shadcn enabling clients to launch and monitor security assessments}
        \resumeItem{Managed and containerized backend services using Docker and FastAPI, providing a scalable runtime for cyber security tools and ML models}
      \resumeItemListEnd
...
\begin{itemize}[leftmargin=0.15in, itemsep=-5pt]
    ...
    \item \small{590 reps on \href{https://stackoverflow.com/users/14313852/shub}{Stack Overflow} with active contributions}
\end{itemize}
